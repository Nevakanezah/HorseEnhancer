package com.nevakanezah.horseenhancer.test.mccoroutine.service
...
internal class TestEventServiceImpl(private val plugin: Plugin) {
    /**
    ...
    fun registerSuspendListener(listener: Listener) {
        ...
        val method = plugin.server.pluginManager::class.java
